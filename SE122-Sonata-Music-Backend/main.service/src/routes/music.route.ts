...
musicRouter
  ...
  .put(
    ...
    authenticateJWT,
    checkRole([RoleCodeEnum.ADMIN]),
    musicController.approveById.bind(musicController)
  )
  ...
  .put(
    ...
    authenticateJWT,
    checkRole([RoleCodeEnum.ADMIN]),
    musicController.rejectById.bind(musicController)
  )
  ...
  .post(
    '/search/waiting-for-approve',
    authenticateJWT,
    checkRole([RoleCodeEnum.ADMIN]),
    musicController.searchWaitingForApprove.bind(musicController)
  )
  ...
  .post(
    ...
    musicController.searchMyUpload.bind(musicController)
  )
