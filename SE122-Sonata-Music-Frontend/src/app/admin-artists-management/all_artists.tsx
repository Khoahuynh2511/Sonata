...
import { Search, X, XCircle, Info, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <div className="w-full">
          ...
          <div className="flex justify-center items-center gap-4 mt-4">
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
            >
              <ChevronLeft size={18} />
              Previous
            </button>
