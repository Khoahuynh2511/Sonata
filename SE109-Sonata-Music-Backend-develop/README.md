# Overview of SE109 SONATA MUSIC BACKEND Project

The **SE109 SONATA MUSIC BACKEND** project is a backend system built using **Node.js** with the **Express.js**.
...
1. **Models (Entities)**:
   ...
   - Define database tables using TypeORM classes, e.g., `Artist`, `Album`, `Music`, `Period`, `Orchestra`, `Quiz`, etc.
...
- **Period Management**:
  ...
  - Create, update, delete, and search for musical periods.

- **Quiz Management**:
  - Create, update, delete, and search for quizzes related to songs.
