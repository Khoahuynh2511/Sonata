...
import { timelessPiecesRepository } from '@/container/timeless_pieces.container';
...
class RecommenderContainer {
  ...
  constructor() {
    ...
    this.container
      .bind<ITimelessPiecesRepository<any>>('TimelessPiecesRepository')
      .toConstantValue(timelessPiecesRepository);
    this.container
